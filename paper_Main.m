...
userInput = input('Type "yes" to run the user-interactive example.\nType "custom" to input STL specification.\n Press Enter if you want to run in-built example ', 's');
...
plot(xlim, [0 0]*0.05, '--r','LineWidth',1.5)
str = sprintf('Min Robustness: %.4f (m)', 10*min_rob);
